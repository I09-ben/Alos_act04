...
class Repository {
  ...
  getUsers() {
    return new Promise((resolve, reject) => {
      ...
      this.connection.query('SELECT email, username,nom_du_film,annee_de_sortie_du_film,duree_du_film,genre_du_film,histoire_du_film FROM directory', (err, results) => {
        if(err) {
